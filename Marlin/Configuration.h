 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 4000, 683 }// calibrated with 15mm dual feeder, both working, nii 3 light blue, 226, 0.4 nozzle 50-100 feed
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          {420, 420, 2.5, 23}    // (mm/sec), for dual feed extruder, motors set to 270-280 mV
